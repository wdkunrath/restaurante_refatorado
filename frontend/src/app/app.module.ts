...
import { RestaurantCrudComponent } from '@app/views/restaurant-crud';
import { UsuariosCrudComponent } from '@app/views/usuarios-crud';
import { SemanasCrudComponent } from '@app/views/semanas-crud';
import { VotacaoCrudComponent } from '@app/views/votacao-crud';
import { ResultadoVotoCrudComponent } from '@app/views/resultado-voto';
